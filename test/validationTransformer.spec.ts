...
const tests: Array<TestParams> = [
    ...
    {
        testName: 'to deeply strictly equal',
        validation: 'to deeply strictly equal',
        positiveArgs: [[{x: 1}, {x: 2}], [{x: 1}, {x: 2}]],
        negativeArgs: [[{x: 1}, {x: 2}], [{x: 2}, {x: 1}]],
        expectedError: 'expected [ { x: 1 }, { x: 2 } ] to deeply strictly equal [ { x: 2 }, { x: 1 } ]',
    },
    {
